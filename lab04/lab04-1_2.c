...
void force(double mass, double acceleration); //changed types taken by force function to match the function code
...
{
    //double mass;
	double mass, acceleration; //initialized acceleration variable
